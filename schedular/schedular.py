from .time_utils import parse_time, add_minute, overlaps
...
def get_free_slots(bookings, working_hours, service_duration, buffer_minute, step=5):
    ...
    while add_minute(current_start, total_required) <= work_end:
        current_end = add_minute(current_start, total_required)
        has_conflict = False
        ...
        current_start = add_minute(current_start, step)
